...
const studentsList = studentsSnap.docs.map(d => ({ id: d.id, ...d.data() }))
    ...
    for (const docSnap of paidCharges) {
      ...
      await addDoc(collection(db, COLLECTIONS.FATURAMENTO), {
        ...
        amount: novoValor,
        status: 'pending', // Nova cobrança é PENDENTE
        dueDate: dueDateStr,
